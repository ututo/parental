...
"""
 ...
 Modificado por David Fernandez
 davidfernandez@riseup.net
 para Proyecto Ututo - www.ututo.org
...
# i18n
gettext.install('ututo-control-parental', '/usr/share/ututo/locale')

#-Variables
user = os.environ.get('SUDO_USER')
hosts = '/etc/hosts'
hosts_tmp = '/usr/lib/ututo/ututo-control-parental/control.tcp'

class ControlP:
    def __init__(self):
        self.glade = gtk.Builder()
        self.glade.add_from_file('/usr/lib/ututo/ututo-control-parental/control-parental.glade')
    ...
    def about(self, widget, data=None):
        self.glade.get_object('about').set_comments(_('Access control to websites for Ututo XS.'))
        ...
        if data != None:
            ...
            if dom != '':
                ...
                if parts[0] == 'www':
                    ...
                    dom = 'www.' + dom + ' ' + dom
        domain = '0.0.0.0\t' + dom + '\t#' + _('blocked by Ututo XS')
